	...
	<div class="wrapper">
		<div class="wrapper_p">
			<div class="signUpBody">
				...
				<form action="Member_IdSearch.do" method="post" name = "signUpForm" class="signUpForm" >
					<div class="signUpFormDiv">
						<h4 style="color:white;">⊙ 현재 입력된 이메일로 메일이 전송됩니다.</h4><br>
						<h4 style="color:white;">⊙ 가입 시 작성된 이름과 이메일이 일치해야합니다.</h4><br>
						...
						<input type="submit" value="아이디 검색" class="signUpBtn" id="submitBtn"/>
					</div>	
