	...
	<div class="wrapper">
		<div class="wrapper_p">
			...
			<div class="signUpBody">
				<form action="Board_Update.do" method="post" name = "signUpForm" class="signUpForm" id="signUpForm" enctype="multipart/form-data">
					<div class="signUpFormDiv">
						...
						<input type="hidden" value="${boardVO.board_index }" name="board_index" />
						<!-- 	<input type="hidden" value="admin" name="member_id" />  -->
						<input type="submit" id="save" value="글수정하기" class="signUpBtn"/>
					</div>	
				</form>
			</div>
		</div>
