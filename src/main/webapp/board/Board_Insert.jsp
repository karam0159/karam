	...
	<div class="wrapper">
		<div class="wrapper_p">
			...
			<div class="signUpBody">
				<form action="Board_Insert.do" method="post" id="signUpForm" name = "signUpForm" class="signUpForm" enctype="multipart/form-data">
					<div class="signUpFormDiv">
						<a>BOARD_TITLE</a><br><input type="text" name="board_title" id="board_title" required="required" maxlength="80"/><br>
						...
						<a>BOARD_IMAGE</a><br><input type="file" name="board_image" id="board_image" value="ok" /><br>
						
						<input type="hidden" value="${memberVO.member_id }" name="member_id" />
